      ...
      <div className="footer-container">
        <div className="footer-row">
          <div className="footer-col">
            <h3 className="footer-heading">Zual<span>Abayas</span></h3>
            <p className="footer-description">
              <strong>Zuyal Abayas</strong> our brand is a reflection of the timeless essence of covering oneself in accordance with the directives of Allah.
            </p>
